...
UNKNOWN >>         #region Windows Form Designer generated code
        ...
        const InitializeComponent = function() {
            ...
            let resources = new System.ComponentModel.ComponentResourceManager(typeof(fMain));
...
UNKNOWN >>         #endregion
        ...
        let mnMain = null;
        let mnFile = null;
        let mnuPageSetup = null;
        let tbMain = null;
        let tsbNew = null;
        let tsbOpen = null;
        let tsbSave = null;
        let tsbSaveAs = null;
        let toolStripSeparator1 = null;
        let tsbDatabase = null;
        let toolStripSeparator2 = null;
        let tsbPreview = null;
        let tsbPrint = null;
        let toolStripSeparator3 = null;
        let tsbProperties = null;
        let tsbControls = null;
        let toolStripSeparator4 = null;
        let tsbAlignLeft = null;
        let tsbAligntCenter = null;
        let tsbAlignRight = null;
        let toolStripSeparator5 = null;
        let tsbBold = null;
        let toolStripSeparator6 = null;
        let tsbSearch = null;
        let mnuNewReport = null;
        let mnuOpenReport = null;
        let mnuSaveReport = null;
        let mnuReportSaveAs = null;
        let toolStripSeparator7 = null;
        let printerSettingsToolStripMenuItem = null;
        let toolStripSeparator8 = null;
        let mnuPreviewReport = null;
        let mnuPrintReport = null;
        let toolStripSeparator9 = null;
        let mnuExit = null;
        let mnEdit = null;
        let mnuCopy = null;
        let mnuPaste = null;
        let toolStripSeparator10 = null;
        let mnuEditSearch = null;
        let toolStripSeparator11 = null;
        let mnuEditAddSec = null;
        let mnuEditAddHeader = null;
        let mnuEditAddGroup = null;
        let mnuEditAddFooter = null;
        let controlsToolStripMenuItem = null;
        let mnuEditAddLabel = null;
        let mnuEditAddLine = null;
        let mnuEditAddControl = null;
        let mnuEditAddImage = null;
        let mnuEditAddChart = null;
        let toolStripSeparator12 = null;
        let mnuEditMove = null;
        let horizontalToolStripMenuItem = null;
        let verticalToolStripMenuItem = null;
        let lockToolStripMenuItem = null;
        let allDirectionsToolStripMenuItem = null;
        let toolStripSeparator13 = null;
        let sizeOfMoveStepWithKeyboardToolStripMenuItem = null;
        let mnView = null;
        let mnuViewToolbar = null;
        let mnuViewControls = null;
        let mnuViewTreeViewCtrls = null;
        let toolStripSeparator14 = null;
        let mnViewGridTool = null;
        let mnuGridPoints = null;
        let mnuGridLines = null;
        let mnuHideGrid = null;
        let mnDatabase = null;
        let mnTool = null;
        let mnHelp = null;
        let mnuConnectionSettings = null;
        let mnuParametersSettings = null;
        let toolStripSeparator15 = null;
        let mnuDataBaseConnectsAuxCfg = null;
        let toolStripSeparator16 = null;
        let mnuDataBaseSetDisconnected = null;
        let manualSettingsToolStripMenuItem = null;
        let mnuDataBaseSQLServerConnection = null;
        let mnuDataBaseConnectConfig = null;
        let mnuDataBaseEditDataSource = null;
        let mnuDataBaseSetToMainConnect = null;
        let mnuOptionsTool = null;
        let mnuHelpAbout = null;
        let sbMain = null;
        let splitContainer1 = null;
        let panel1 = null;
        let tab_sidebar = null;
        let tabPage3 = null;
        ...
        let pnRule = null;
        let pnReport = null;
        let mnuFileRecentList = null;
        let openFileDlg = null;
        let saveFielDlg = null;
        let tabPage1 = null;
        let cmnControl = null;
        let cmCtrlProperties = null;
        let cmCtrlCopy = null;
        let toolStripSeparator17 = null;
        let cmCtrlDelete = null;
        let toolStripSeparator18 = null;
        let cmCtrlEditText = null;
        let toolStripSeparator20 = null;
        let cmCtrlSendBack = null;
        let cmCtrlBringFront = null;
        let toolStripSeparator19 = null;
        let cmCtrlPaste = null;
        let cmCtrlPasteEx = null;
        let cmnSection = null;
        let cmSectionAddSectionLine = null;
        let toolStripSeparator21 = null;
        let cmSectionDeleteSection = null;
        let cmSectionDeleteSectionLine = null;
        let toolStripSeparator22 = null;
        let cmSectionSectionProperties = null;
        let cmSectionSectionLineProperties = null;
        let cmSectionGroupProperties = null;
        let cmSectionGroupSeparator = null;
        let cmSectionMoveGroup = null;
        let toolStripSeparator23 = null;
        let columnHeader1 = null;
        let imageList = null;
        let columnHeader2 = null;
        let lv_properties = null;
        let columnHeader3 = null;
        let columnHeader4 = null;
        let imageListTree = null;
        let mnuPasteSpecial = null;
        let printDlg = null;
        let tsbCtrlAlignLeft = null;
        let tsbCtrlAlignRight = null;
        let tsbCtrlAlignTop = null;
        let tsbCtrlAlignBottom = null;
        let toolStripSeparator24 = null;
        let tsbCtrlSameHeight = null;
        let tsbCtrlSameWidth = null;
        let tsbCtrlSameLeft = null;
        let tsbCtrlSameTop = null;
    }
}
