...
UNKNOWN >>         #endregion
        ...
        let tbpFormat = null;
        let label24 = null;
        let tx_exportColIdx = null;
        let label23 = null;
        let chk_isFreeCtrl = null;
        let label22 = null;
        let chk_wordWrap = null;
        let chk_canGrow = null;
        let label21 = null;
        let label20 = null;
        let tx_width = null;
        let label19 = null;
        ...
        let label14 = null;
        let tx_format = null;
        let chk_transparent = null;
        let sh_backColor = null;
        let label11 = null;
        let tx_backColor = null;
        let chk_fontStrike = null;
        let chk_fontItalic = null;
        let sh_foreColor = null;
        let label9 = null;
        let tx_foreColor = null;
        let chk_fontUnderline = null;
        let chk_fontBold = null;
        let label8 = null;
        let cb_align = null;
        let label7 = null;
        let tx_fontSize = null;
        let label6 = null;
        let tx_font = null;
        let label5 = null;
        let tx_tag = null;
        ...
        let label2 = null;
        let tx_name = null;
        let tbpFormulas = null;
        let tbpDatabase = null;
        let tbpImage = null;
        let tbpBorders = null;
        let tbpChart = null;
        let cmd_apply = null;
        ...
        let groupBox3 = null;
        let label41 = null;
        let op_afterPrint = null;
        let op_beforePrint = null;
        let label40 = null;
        let label39 = null;
        let tx_idxGroup = null;
        let label37 = null;
        let label38 = null;
        let label35 = null;
        let label36 = null;
        ...
        let label28 = null;
        let groupBox2 = null;
        let lb_formulaValue = null;
        let chk_formulaValue = null;
        let cmd_formulaValue = null;
        let groupBox1 = null;
        let lb_formulaHide = null;
        let label25 = null;
        let chk_formulaHide = null;
        let cmd_formulaHide = null;
        let cmd_dbField = null;
        let label42 = null;
        let tx_dbField = null;
        let pic_image = null;
        let cmd_imageFile = null;
        let label43 = null;
        let tx_imageFile = null;
        let chk_borderRounded = null;
        let label51 = null;
        let tx_borderWidth = null;
        let sh_borderShadow = null;
        let label50 = null;
        let tx_borderShadow = null;
        let sh_border3D = null;
        let label45 = null;
        let tx_border3D = null;
        let sh_borderColor = null;
        let label47 = null;
        let tx_borderColor = null;
        let label48 = null;
        let cb_borderType = null;
        let label56 = null;
        let cb_chartThickness = null;
        let label54 = null;
        let cb_chartSize = null;
        let label55 = null;
        let cb_linesType = null;
        let label53 = null;
        let cb_formatType = null;
        let label52 = null;
        let cb_type = null;
        let chk_sort = null;
        let chk_showOutlines = null;
        let chk_showBarValues = null;
        let label59 = null;
        let tx_chartTop = null;
        let groupBox5 = null;
        let label63 = null;
        let cb_colorSerie2 = null;
        let cmd_dbFieldLbl2 = null;
        let label64 = null;
        let tx_dbFieldLbl2 = null;
        let cmd_dbFieldVal2 = null;
        let label65 = null;
        let tx_dbFieldVal2 = null;
        let groupBox4 = null;
        let label62 = null;
        let cb_colorSerie1 = null;
        let cmd_dbFieldLbl1 = null;
        let label61 = null;
        let tx_dbFieldLbl1 = null;
        let cmd_dbFieldVal1 = null;
        let label60 = null;
        let tx_dbFieldVal1 = null;
        let label58 = null;
        let tx_chartGroupValue = null;
        let cmd_dbFieldGroupValue = null;
        let label57 = null;
        let tx_dbFieldGroupValue = null;
        let cmd_backColor = null;
        let cmd_foreColor = null;
        let cmd_borderShadowColor = null;
        let cmd_borderColor3d = null;
        let cmd_borderColor = null;
        let lb_control = null;
