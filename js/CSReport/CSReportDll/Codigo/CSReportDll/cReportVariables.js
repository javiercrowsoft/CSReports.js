(function(globalObject) {
 ...
 //@@@: {
    globalObject.CSReportDll.createCReportVariables = function() {
        ...
        const self = {}; //@@@: public class cReportVariables : NameObjectCollectionBase

        // Creates an empty collection.
        const cReportVariables = function() { //@@@: public cReportVariables()
        }; //@@@: }

        // Adds elements from an IDictionary into the new collection.
        const cReportVariables = function(d, bReadOnly) { //@@@: public cReportVariables(IDictionary d, Boolean bReadOnly)
...
UNKNOWN >>             get //@@@: get
        ...
        self.item = function(key) { //@@@: public cReportVariable item(String key)
            try { //@@@: try
                return this.BaseGet(key); //@@@: return (cReportVariable)this.BaseGet(key);
            } //@@@: }
            catch(ex) { //@@@: catch
        ...
        self.item = function(index) { //@@@: public cReportVariable item(int index)
            try { //@@@: try
                return this.BaseGet(index); //@@@: return (cReportVariable)this.BaseGet(index);
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
        ...
        self.add = function(c, key) { //@@@: internal cReportVariable add(cReportVariable c, String key)
            try { //@@@: try

                if (c === null) { //@@@: if (c == null)
                    c = new cReportVariable(); //@@@: c = new cReportVariable();
                } //@@@: }
