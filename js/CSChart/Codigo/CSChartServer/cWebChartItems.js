(function(globalObject) {
 ...
 //@@@: {
    globalObject.CSChartServer.createCWebChartItems = function() {
        ...
        const self = {}; //@@@: public class cWebChartItems : NameObjectCollectionBase

        // Creates an empty collection.
        const cWebChartItems = function() { //@@@: public cWebChartItems()
        }; //@@@: }

        // Adds elements from an IDictionary into the new collection.
        const cWebChartItems = function(d, bReadOnly) { //@@@: public cWebChartItems(IDictionary d, Boolean bReadOnly)
...
UNKNOWN >>             get //@@@: get
        ...
        self.add = function(c) { //@@@: public cWebChartItem add(cWebChartItem c)
            return add(c, ""); //@@@: return add(c, "");
        }; //@@@: }

        self.add = function(c, key) { //@@@: public cWebChartItem add(cWebChartItem c, String key)
            try { //@@@: try
                if (c === null)  { //@@@: if (c == null)
                    c = new cWebChartItem(); //@@@: c = new cWebChartItem();
                } //@@@: }
        ...
        self.item = function(key) { //@@@: public cWebChartItem item(String key)
            try { //@@@: try
                return this.BaseGet(key); //@@@: return (cWebChartItem)this.BaseGet(key);
            } //@@@: }
            catch (ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
        ...
        self.item = function(index) { //@@@: public cWebChartItem item(int index)
            try { //@@@: try
                return this.BaseGet(index); //@@@: return (cWebChartItem)this.BaseGet(index);
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
