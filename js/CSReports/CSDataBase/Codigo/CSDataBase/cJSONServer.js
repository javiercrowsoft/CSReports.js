(function(globalObject) {
 ...
 //@@@: {
    globalObject.CSDataBase.createCJSONServer = function() {
        ...
        const self = {}; //@@@: public static class cJSONServer
        let cJSONDataSources m_dataSources = new cJSONDataSources(); //@@@: private static cJSONDataSources m_dataSources = new cJSONDataSources();

        self.registerDataSource = function(dataSource, name) { //@@@: public static void registerDataSource(cJSONDataSource dataSource, string name)
            m_dataSources.add(dataSource, name.ToLower()); //@@@: m_dataSources.add(dataSource, name.ToLower());
        }; //@@@: }

        self.getDataSource = function(name) { //@@@: public static cJSONDataSource getDataSource(string name) {
            return m_dataSources.item(name.ToLower()); //@@@: return m_dataSources.item(name.ToLower());
        }; //@@@: }
        return self;
...
UNKNOWN >>         return self;
    ...
    class cJSONServerConnection : DbConnection //@@@: class cJSONServerConnection : DbConnection
    { //@@@: {
        //
        // Summary:
        //     Initializes a new instance of the System.Data.SqlClient.SqlConnection class.
        self. = function() { //@@@: public cJSONServerConnection() { }
        //
        // Summary:
        ...
        self. = function(connectionString) { //@@@: public cJSONServerConnection(string connectionString)
        ...
        self.string ConnectionString { get = null; set; }; //@@@: public override string ConnectionString { get; set; }
        //
        // Summary:
        ...
        self.int ConnectionTimeout { get = null; }; //@@@: public override int ConnectionTimeout { get; }
        //
        // Summary:
        ...
        self.string Database { get = null; }; //@@@: public override string Database { get; }
        //
        // Summary:
        ...
        //     is an empty string.
        self.string DataSource { get = null; }; //@@@: public override string DataSource { get; }
        //
        // Summary:
        ...
        self.FireInfoMessageEventOnUserErrors { get = null; set; }; //@@@: public bool FireInfoMessageEventOnUserErrors { get; set; }
        //
        // Summary:
        ...
        self.PacketSize { get = null; }; //@@@: public int PacketSize { get; }
        //
        // Summary:
        ...
        self.string ServerVersion { get = null; }; //@@@: public override string ServerVersion { get; }
        //
        // Summary:
        ...
        self.ConnectionState State { get = null; }; //@@@: public override ConnectionState State { get; }
        //
        // Summary:
        ...
        //     default.
        self.StatisticsEnabled { get = null; set; }; //@@@: public bool StatisticsEnabled { get; set; }
        //
        // Summary:
        ...
        self.WorkstationId { get = null; }; //@@@: public string WorkstationId { get; }
UNKNOWN >>         protected override DbProviderFactory DbProviderFactory { get; } //@@@: protected override DbProviderFactory DbProviderFactory { get; }
        ...
        self. = function(database) { //@@@: public override void ChangeDatabase(string database) { }
        //
        // Summary:
        ...
        self. = function() { //@@@: public override DataTable GetSchema() { throw new NotImplementedException(); }
        //
        // Summary:
        //     Returns schema information for the data source of this System.Data.SqlClient.SqlConnection
        ...
        self. = function(collectionName) { //@@@: public override DataTable GetSchema(string collectionName) { throw new NotImplementedException(); }
        //
        // Summary:
        //     Returns schema information for the data source of this System.Data.SqlClient.SqlConnection
        ...
        //   T:System.ArgumentException:
        //     collectionName is specified as null.
        self. = function(collectionName, restrictionValues) { //@@@: public override DataTable GetSchema(string collectionName, string[] restrictionValues)
        //
        // Summary:
        ...
        self. = function() { //@@@: public override void Open() { }

        self. = function(isolationLevel) { //@@@: protected override DbTransaction BeginDbTransaction(IsolationLevel isolationLevel) { throw new NotImplementedException(); }
        self. = function() { //@@@: protected override DbCommand CreateDbCommand() { throw new NotImplementedException(); }
