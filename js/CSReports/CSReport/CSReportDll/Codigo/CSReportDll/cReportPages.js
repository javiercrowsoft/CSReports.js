(function(globalObject) {
 ...
 //@@@: {
    ...
    globalObject.CSReportDll.createCReportPages = function() {
        ...
        const self = {}; //@@@: public class cReportPages : NameObjectCollectionBase

        // Creates an empty collection.
        const cReportPages = function() { //@@@: public cReportPages()
        }; //@@@: }

        // Adds elements from an IDictionary into the new collection.
        const cReportPages = function(d, bReadOnly) { //@@@: public cReportPages(IDictionary d, Boolean bReadOnly)
...
UNKNOWN >>             get //@@@: get
        ...
        self.add = function(c) { //@@@: public cReportPage add(cReportPage c)
            return add(c, ""); //@@@: return add(c, "");
        }; //@@@: }

        self.add = function(c, key) { //@@@: public cReportPage add(cReportPage c, String key)
            try { //@@@: try
                if (c === null) { //@@@: if (c == null)
                    c = new cReportPage(); //@@@: c = new cReportPage();
                } //@@@: }
        ...
        self.item = function(key) { //@@@: public cReportPage item(String key)
            try { //@@@: try
                let (cReportPage)this.BaseGet(key) = null; ; //@@@: return (cReportPage)this.BaseGet(key); ;
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
        ...
        self.item = function(index) { //@@@: public cReportPage item(int index)
            try { //@@@: try
                let (cReportPage)this.BaseGet(index) = null; ; //@@@: return (cReportPage)this.BaseGet(index); ;
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
