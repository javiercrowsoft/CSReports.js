(function(globalObject) {
 ...
 //@@@: {
    globalObject.CSReportDll.createCReportPageSettings = function() {
        ...
        const self = {}; //@@@: public class cReportPageSettings : NameObjectCollectionBase

        // Creates an empty collection.
        const cReportPageSettings = function() { //@@@: public cReportPageSettings()
        }; //@@@: }

        // Adds elements from an IDictionary into the new collection.
        const cReportPageSettings = function(d, bReadOnly) { //@@@: public cReportPageSettings(IDictionary d, Boolean bReadOnly)
...
UNKNOWN >>             get //@@@: get
        ...
        self.add = function( //@@@: public cReportPageInfo add(
            sectionLine,  //@@@: cReportSectionLine sectionLine,
            c,  //@@@: cReportPageInfo c,
            key) { //@@@: String key)
            try { //@@@: try
                if (c === null)  { //@@@: if (c == null)
                    c = new cReportPageInfo(); //@@@: c = new cReportPageInfo();
                } //@@@: }
                if (key === "") { //@@@: if (key == "")
                ...
                Add(key, c); //@@@: Add(key, c);
                c.setSectionLine(sectionLine); //@@@: c.setSectionLine(sectionLine);
                return c; //@@@: return c;
            } //@@@: }
            catch(ex) { //@@@: catch
        ...
        self.item = function(key) { //@@@: public cReportPageInfo item(String key)
            try { //@@@: try
                return this.BaseGet(key); //@@@: return (cReportPageInfo)this.BaseGet(key);
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
        ...
        self.item = function(index) { //@@@: public cReportPageInfo item(int index)
            try { //@@@: try
                return this.BaseGet(index); //@@@: return (cReportPageInfo)this.BaseGet(index);
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
