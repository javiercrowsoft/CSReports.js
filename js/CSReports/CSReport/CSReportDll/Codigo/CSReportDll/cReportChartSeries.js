(function(globalObject) {
 ...
 //@@@: {
    globalObject.CSReportDll.createCReportChartSeries = function() {
        ...
        const self = {}; //@@@: public class cReportChartSeries : NameObjectCollectionBase

        // Creates an empty collection.
        const cReportChartSeries = function() { //@@@: public cReportChartSeries()
        }; //@@@: }

        // Adds elements from an IDictionary into the new collection.
        const cReportChartSeries = function(d, bReadOnly) { //@@@: public cReportChartSeries(IDictionary d, Boolean bReadOnly)
...
UNKNOWN >>             get //@@@: get
		...
		self.add = function() { //@@@: public cReportChartSerie add()
			return add(null, ""); //@@@: return add(null, "");
		}; //@@@: }

        self.add = function(c, key) { //@@@: public cReportChartSerie add(cReportChartSerie c, String key)
            try { //@@@: try
                if (c === null)  { //@@@: if (c == null)
                    c = new cReportChartSerie(); //@@@: c = new cReportChartSerie();
                } //@@@: }
        ...
        self.item = function(key) { //@@@: public cReportChartSerie item(String key)
            try { //@@@: try
                return this.BaseGet(key); //@@@: return (cReportChartSerie)this.BaseGet(key);
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
        ...
        self.item = function(index) { //@@@: public cReportChartSerie item(int index)
            try { //@@@: try
                return this.BaseGet(index); //@@@: return (cReportChartSerie)this.BaseGet(index);
            } //@@@: }
            catch(ex) { //@@@: catch
                return null; //@@@: return null;
            } //@@@: }
